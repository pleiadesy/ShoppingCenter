...
const mouseEnterFn = (i) => currentIndex.value = i
...
// 鼠标移动时，滑块需要跟着移动
const left = ref(0)  // 滑块左侧相对于盒子左侧的距离
const top = ref(0)  // 滑块顶部相对于盒子顶部的距离
// 放大镜图中显示的图片位置
...
<template>
  <div class="goods-image">
    ...
    <ul class="small">
      ...
      :key="i" @mouseenter="mouseEnterFn(i)"  :class="{active: i === currentIndex}">
        <img :src="img" alt="" />
      </li>
    </ul>
    <!-- 放大镜大图 -->
