    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${goodsDetail.categories[1].id}` }">母婴
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/sub/${goodsDetail.categories[0].id}` }">跑步鞋
          </el-breadcrumb-item>
          <el-breadcrumb-item>{{goodsDetail.desc}}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 商品信息 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="img in goodsDetail.details.pictures" :key="img" :src="img" alt="">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
